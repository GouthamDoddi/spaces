...
export function EditIcon(props) {
  const { onClick, color, fill } = props

  return (
    <div className='icon' onClick={onClick}>
      <svg xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          <rect width="44" height="44" fill={fill} rx="12"/>
          <g>
            <path d="M0 0L24 0 24 24 0 24z" transform="translate(9 10)"/>
            <path fill={color} fillRule="nonzero" d="M15.728 9.686l-1.414-1.414L5 17.586V19h1.414l9.314-9.314zm1.414-1.414l1.414-1.414-1.414-1.414-1.414 1.414 1.414 1.414zM7.242 21H3v-4.243L16.435 3.322c.39-.39 1.024-.39 1.414 0l2.829 2.829c.39.39.39 1.024 0 1.414L7.243 21h-.001z" transform="translate(9 10)"/>
          </g>
        </g>
      </svg>
    </div>
    ...
    <div className='icon' onClick={onClick}>
      <svg xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          ...
          <g>
            <path d="M0 0L24 0 24 24 0 24z" transform="translate(9 10)"/>
            <path fill={color} fillRule="nonzero" d="M8 19v-6h10v6h2V7.828L17.172 5H6v14h2zM5 3h13l4 4v13c0 .552-.448 1-1 1H5c-.552 0-1-.448-1-1V4c0-.552.448-1 1-1zm5 12v4h6v-4h-6z" transform="translate(9 10)"/>
          </g>
        </g>
      </svg>
    </div>
