...
function useLinkTo(path, exact=false) {
  return(useTo(`support-model/${path}`, exact))
}
    ...
    <>
      <div className='form-space'>
        <Switch>
          ...
          <Route path={useLinkTo('tickets')}> <Tickets /> </Route>
          <Route path={useLinkTo('queues')}> <Queues /> </Route>
      ...
      <div className='widgets'>
        <Widget>
          ...
          <Link to='tickets' className='menu'>
            <div className='title'> Tickets </div>
            <div className='desc'>
              Project scope & beneficiary details
            </div>
          </Link>
          <Link to='queues' className='menu'>
            <div className='title'> Queues </div>
            <div className='desc'>
