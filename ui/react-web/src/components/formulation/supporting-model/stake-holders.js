...
const { store, load } =  makeStore(({policy_id, id}) => `formulation/${policy_id}/sp/stake-holders`)

const {changed, selectChange, addData, remove, ...localState} = makeStore(({policy_id, id}) => id ? `formulation/${policy_id}/sp/stake-holders/${id}` : `formulation/${policy_id}/sp/stake-holders`)
