...
const { store, load, create, update } =  makeStore(({policy_id, id}) => `formulation/${policy_id}/op/stake-holders`)

const {changed, selectChange, addData, remove, ...localState} = makeStore(({policy_id, id}) => id ? `formulation/${policy_id}/op/stake-holders/${id}` : `formulation/${policy_id}/op/stake-holders`)
