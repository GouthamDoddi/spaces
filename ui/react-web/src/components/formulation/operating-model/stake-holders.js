...
const {changed, selectChange, addData, ...localState} = makeStore(({policy_id, id}) => id ? `formulation/${policy_id}/op/stake-holders/${id}` : `formulation/${policy_id}/op/stake-holders`)
