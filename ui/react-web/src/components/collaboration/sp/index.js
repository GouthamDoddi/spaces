...
function ElementWidget(props) {
  ...
  return(
    <Menu to={`${props.id}/1`} key={props.key} color={color}>
...
const ListOfThings = [
  ...
  { id: 2, name: 'Petition One', attenmpted_ppl_count: 234, due_date: '8 May 2020', type: 'petition'},
  { id: 3, name: 'Survey two', attenmpted_ppl_count: 234, due_date: '8 May 2020', type: 'survey'},
  { id: 4, name: 'Survey three', attenmpted_ppl_count: 234, due_date: '8 May 2020', type: 'survey'},
