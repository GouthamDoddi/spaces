              ...
              <div className="flex_row">
                <div className="flex_col_sm_12">
                  <DisplayItemFlex>
                    ...
                    />
                    <LabelCaseID>{'Ground ID: 2356'}</LabelCaseID>
                    <SubmittedIcon>{'Active'}</SubmittedIcon>
                  </DisplayItemFlex>
                  ...
                  <OuterRowSpace extraSpace={true} className="flex_row">
                    <div className="flex_col_sm_12">
                      ...
                      <OuterRowSpace noSpace={true} className="flex_row">
                        <div className="flex_col_sm_4">
                          <TextCustom fontSmall={true}>{'John Doe'}</TextCustom>
                        </div>
                        <div className="flex_col_sm_4">
                  ...
                  <OuterRowSpace extraSpace={true} className="flex_row">
                    <div className="flex_col_sm_12">
                      <TextCustom greyColor={true}>{'Categories'}</TextCustom>
                      <br />
                      <br />
                      {['Exception Grounds'].map((item) => (
                        <SpanCategory>{item}</SpanCategory>
                      ))}
                    </div>
                  </OuterRowSpace>
                  ...
                  <OuterRowSpace noSpace={true} className="flex_row">
                    <div className="flex_col_sm_12">
                      <TextCustom greyColor={true}>{'Mark as'}</TextCustom>
                      <InfoOutlinedIcon
                        style={{ height: '15px', fill: '#999999' }}
                      />
                    </div>
                  </OuterRowSpace>
...
const TextCustom = styled.span`
  ...
  font-size: ${(props) =>
    props.bigFont ? '20px' : props.fontSmall ? '12px' : '14px'};
