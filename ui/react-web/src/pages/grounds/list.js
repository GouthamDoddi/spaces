...
const headlines = [
    ...
    { headline: 'Ground ID', key: 'ground_id' },
    { headline: 'Title', key: 'title' },
    { headline: 'Category', key: 'category' },
    { headline: 'Created By', key: 'created_by' },
    { headline: 'Created On', key: 'created_on' },
    { headline: 'Proposed Date', key: 'proposed_date' },
];
    ...
    <>
      <div className="entity_cards">
        <ul className="entity_boardcard_wrap">
          ...
          <li className="entity_boardcard">
            <a className="inner_wrap">
              <span className="title">Initiative Request</span>
